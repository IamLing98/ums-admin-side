...
import { Button, TreeSelect, Modal, Select, Spin, Tabs } from "antd";
...
export const GraduationHome = (props) => {
    ...
    return (
      <Spin spinning={spinLoading}>
        ...
        <Tabs onChange={callback} type="card">
          <TabPane tab="Danh sách dự kiến" key="1">
            <ResultList data={currentData} departmentList={departmentList} />
          </TabPane>
          <TabPane tab="Danh sách đạt" key="2">
