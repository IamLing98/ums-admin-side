    ...
    return (
        ...
        >
            ...
            <div className="ant-row ant-form-item" style={{ margin: "0rem 0rem" }}>
                <div className="ant-col ant-col-4 ant-form-item-label" style={{ flex: "none" }}>
                    <label title="Kỳ học: " style={{ fontWeight: "500" }}>Kỳ học: </label>
                </div>
                                                        ...
                                                        <span
                                                            ...
                                                            onClick={
                                                                () => {
                                                                    ...
                                                                    var newSelected = selected1.filter(function (element) {
