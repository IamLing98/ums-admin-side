    ...
    return (
        ...
        >
            ...
            <div className="form-group row  type-TEXT">
                ...
                <div className="col-12 col-sm-8"  >
                    <select className="ant-input" onChange={e => setEducationProgramLevel(e.target.value)} value={educationProgramLevel}>
            ...
            <div className="form-group row  type-TEXT">
                ...
                <div className="col-12 col-sm-8"  >
                    <select className="ant-input" onChange={e => setEducationProgramType(e.target.value)} value={educationProgramType}>
