...
import { Modal, Form, Select, Slider, Radio,Input  } from "antd"; 
import { api } from "Api";
...
const SubjectClassUpdate = (props) => {
  ...
  return (
    ...
    >
      <Form
        form={form}
        {...formItemLayout}
        initialValues={{ ...props.recordUpdate, subjectClass: props.recordUpdate.subjectClassId + " - " + props.recordUpdate.subjectName }}
...
export default SubjectClassUpdate;
