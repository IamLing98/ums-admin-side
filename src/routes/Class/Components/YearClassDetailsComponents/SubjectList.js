...
const EducationProgramDetail = (props) => {
  ...
  if (educationProgram === null || educationProgram === undefined) {
    return (
      <Result
        status="404"
        title="404"
  ...
  return (
    <>
      ...
      <Alert
        message={`Chương Trình Đạo Tạo: ${props.educationProgram.educationProgramName}. Tổng số học phần: ${educationProgram.subjectList.length}. Tổng số tín chỉ: ${totalCredit} `}
        type="info"
        showIcon
      ...
      <Table
        columns={columns}
        dataSource={educationProgram.subjectList}
        rowKey="subjectId"
        bordered
        size="small"
        rowSelection={true}
