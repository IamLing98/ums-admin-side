...
export const StudentUpdate = (props) => {
  ...
  const getStudentDetail = () => {
    api
      .get(`/students/${props.visible.studentId}`)
      .then((res) => {
        setStudent(res);
        form.resetFields();
        setLoading(false);
        ...
        onOk={() => {
          form
            ...
            .then((values) => {
              form.resetFields();
              console.log(values);
              props.handleSubmitUpdateForm([values]);
            })
            .catch((info) => {
            ...
            <Col span={12}>
              ...
              <Form.Item
                ...
                rules={[
                  {
                    required: true,
                    message: "Vui lòng chọn chính sách ưu tiên!!!",
                  },
                ]}
                disabled
              >
              ...
              <Form.Item
                ...
                rules={[
                  {
                    required: true,
                    message: "Vui lòng chọn chương trình đào tạo!!!",
                  },
                ]}
              >
                <Select
                  ...
                  onChange={(value) => {
                    ...
                    if (edu.length) {
                      ...
                      form.setFieldsValue({
                        departmentId: edu[0].departmentId,
                      });
              ...
              >
                ...
                >
                  {classList.map((item, index) => {
                    return (
                      <Option
                        key={index + "ClassOpts" + item.classId}
                        value={item.classId}
                      >
                        {" "}
