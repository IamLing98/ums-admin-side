...
export const wsTypes = {
    ...
    SOCKETS_DISCONNECTED :'SOCKETS_DISCONNECTED',
    ...
    SOCKETS_MESSAGE_SUBSCRIBE :'SOCKETS_MESSAGE_SUBSCRIBE',
}

export const notifiactionsTypes = {
    NOTIFICATIONS_GET_LIST : 'NOTIFICATIONS_GET_LIST',
    NOTIFICATIONS_GET_LIST_SUCCESS:'NOTIFICATIONS_GET_LIST_SUCCESS',
    NOTIFICATIONS_GET_LIST_FAILED : 'NOTIFICATIONS_GET_LIST_FAILED',
    //set read notifications
    NOTIFICATIONS_SET_READ: 'NOTIFICATIONS_SET_READ',
    NOTIFICATIONS_SET_READ_SUCCESS: 'NOTIFICATIONS_SET_READ_SUCCESS',
    NOTIFICATIONS_SET_READ_FAILED: 'NOTIFICATIONS_SET_READ_FAILED',
