...
class NavMenuItemAdmin extends Component {
   ...
   */
   ...
   render() {
      const { menu, onAdminToggleMenu } = this.props;
      const { subMenuOpen } = this.state;
      if (menu.child_routes != null) {
         return (
            <Fragment>
               <ListItem button component="li" onClick={onAdminToggleMenu} className={`list-item ${classNames({ 'item-active': menu.open })}`}>
...
export default NavMenuItemAdmin;
