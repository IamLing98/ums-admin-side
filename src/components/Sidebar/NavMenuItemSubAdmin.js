...
class NavMenuItemSubAdmin extends Component {
   ...
   */
   ...
   render() {
      const { menu, onSubToggleMenu } = this.props;
      const { subMenuOpen } = this.state;
      if (menu.child_routes != null) {
         return (
            <Fragment>
               <ListItem button component="li" onClick={onSubToggleMenu} className={`list-item ${classNames({ 'item-active': menu.open })}`}>
...
export default NavMenuItemSubAdmin;
