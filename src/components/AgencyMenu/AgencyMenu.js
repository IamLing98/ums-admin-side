...
class AgencyMenu extends Component {
  ...
  componentDidMount() {
    ...
    $(".agency-menu .nav .nav-item .active")
      .parents(".agency-menu .nav > .nav-item")
      .addClass("nav-item-active");
  }
