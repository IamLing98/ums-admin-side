...
import { socketsSubscribe, socketsConnect, socketsMessageSend } from "../../store/actions/WebSocketsActions";
...
// map state to props
const mapStateToProps = ({ settings, webSocketReducer }) => {
  return { settings, webSocketReducer };
};
